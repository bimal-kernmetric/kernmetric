  ...
  async function renderCompanyNode(company) {
    ...
    viewPanel.innerHTML = `
      ...
      <p style="margin-bottom: var(--space-lg);">
        This brand's subscription cohorts, unit pricing dynamics, and multi-channel attribution configurations have been audited and indexed within the KernMetrics growth intelligence OS.
      </p>
  ...
  async function renderResearchNode(paper) {
    ...
    viewPanel.innerHTML = `
      ...
      <div class="text-center" style="margin-top: var(--space-md);">
        <a href="research.html?id=${paper.id}" class="btn btn-secondary btn-sm">Read in Research Publication View</a>
      </div>
